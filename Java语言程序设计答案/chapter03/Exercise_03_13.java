...
public class Exercise_03_13 {
    public static void main(String[] args) {
        ...
        System.out.print(
                "(0-single filer, 1-marride jointly or qualifying widow(er), 2-marride separately, 3-head of household)Enter the filing status: ");
        ...
        switch (status) {
            ...
            case 2:
                if (income <= 8350) {
                    ...
                    tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
                            + (186475 - 104425) * 0.33 + (income - 186474) * 0.35;
                }
                break;
            case 3:
                if (income <= 11950) {
