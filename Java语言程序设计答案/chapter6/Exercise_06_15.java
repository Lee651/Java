...
public class Exercise_06_15 {
    public static void main(String[] args) {
        ...
        for (double i = 50000.0; i <= 60000.0; i += 50.0) {
            System.out.printf("%-12d", (int) i);
            for (int j = 0; j < 4; j++) {
                if (j == 3) {
                    System.out.printf("%-12d\n", Math.round(computeTax(j, i)));
                } else {
                    System.out.printf("%-12d", Math.round(computeTax(j, i)));
                }
            }
        }
    }
        ...
        switch (status) {
            ...
            case 2:
                if (taxableIncome <= 8350) {
                    ...
                    tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (taxableIncome -186474) * 0.35; 
                }
                break;
            case 3:
